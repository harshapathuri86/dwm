...
static Key keys[] = {
    ...
    {0, XF86XK_AudioRaiseVolume, spawn,
     SHCMD("wpctl set-volume @DEFAULT_AUDIO_SINK@ 2%+; kill -44 $(pidof "
           "dwmblocks)")},
    ...
    {0,
     ...
     spawn,
     {.v = (const char *[]){"xbacklight", "-inc", "5", NULL}}},
    {0,
     XF86XK_MonBrightnessDown,
     spawn,
     {.v = (const char *[]){"xbacklight", "-dec", "5", NULL}}},
