...
static char *fonts[]          = { "Iosevka Etoile:pixelsize=12:antialias=true:autohint=true", "JoyPixels:pixelsize=12:antialias=true:autohint=true","Nerd-Symbols:pixelsize=12:antialias=true:autohint=true"};
...
/* tagging */
static const char *tags[] = {">_", "www", "🎶", "4", "5", "6", "7", "8", "bg"};
...
/* commands */
static const char dmenufont[]       = "Iosevka Etoile:size=12";
...
static Key keys[] = {
	...
	{ MODKEY,			XF86XK_WebCam,		spawn,		SHCMD("mpv --untimed --no-cache --no-osc --no-input-default-bindings --profile=low-latency --input-conf=/dev/null --title=webcam $(ls /dev/video[0,2,4,6,8] | tail -n 1)") },
	...
	{0, XF86XK_RFKill,          spawn,      {.v = (const char*[]){ "sysact", NULL } } },
